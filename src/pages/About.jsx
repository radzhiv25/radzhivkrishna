  ...
  return (
    <div className="md:my-20 my-10">
      <div className="md:mb-20 mb-10">
        ...
        <div className='lg:text-5xl text-3xl font-bold text-gray-400 lg:col-span-2 md:leading-none leading-none'>I&apos;m
          <span className='text-black dark:text-white'> Rajeev</span>
